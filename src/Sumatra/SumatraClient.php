...
class SumatraClient extends Client
{
    ...
    {
        return $this->call('abgleich', $abgleich_argument);
    }
    ...
    {
        return $this->call('kundenvertraege_uebermittlung', $kundenvertraege_uebermittlung_argument);
    }
}
